    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_tests_status', models.CharField(blank=True, choices=[('running', 'running'), ('waiting', 'waiting'), ('passed', 'passed'), ('failed', 'failed'), ('warning', 'warning'), ('error', 'error'), ('unknown', 'unknown'), ('aborted', 'aborted')], default=None, max_length=9, null=True)),
            ],
            options={
                'ordering': ['-pk'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basescript_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tm_api.BaseScript')),
                ('status', models.CharField(choices=[('running', 'running'), ('waiting', 'waiting'), ('passed', 'passed'), ('failed', 'failed'), ('warning', 'warning'), ('error', 'error'), ('unknown', 'unknown'), ('aborted', 'aborted')], default='unknown', max_length=9)),
