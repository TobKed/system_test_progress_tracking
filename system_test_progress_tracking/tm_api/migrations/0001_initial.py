# Generated by Django 2.1.4 on 2018-12-27 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_tests_status', models.CharField(blank=True, choices=[('running', 'running'), ('cancelled', 'cancelled'), ('failed', 'failed'), ('error', 'error'), ('warning', 'warning'), ('waiting', 'waiting'), ('unknown', 'unknown'), ('passed', 'passed')], db_column='tests_status', default=None, max_length=9, null=True)),
            ],
            options={
                'ordering': ['-pk'],
            },
